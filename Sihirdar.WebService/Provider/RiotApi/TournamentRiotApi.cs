...
using Sihirdar.WebService.Provider.RiotApi.Model.TournamentEndpoint;
using Sihirdar.WebService.Provider.RiotApi.Model.Misc;
using Sihirdar.WebService.Provider.RiotApi.Model.TournamentEndpoint.Enums;
...
namespace Sihirdar.WebService.Provider.RiotApi
{
    public class TournamentRiotApi : ITournamentRiotApi
    {
        ...
        private TournamentRiotApi(RiotApiConfig config)
        {
            //_config = config;
            //GetInstance(config);
            Requesters.TournamentApiRequester = new RateLimitedRequester(config.ApiKey, config.RateLimitPer10S, config.RateLimitPer10M);
        ...
        //public static TournamentRiotApi GetInstance(RiotApiConfig config)
        //{
        //    if (_instance == null ||
        //        Requesters.TournamentApiRequester == null ||
        //        config.ApiKey != Requesters.TournamentApiRequester.ApiKey ||
        //        config.RateLimitPer10S != Requesters.TournamentApiRequester.RateLimitPer10S ||
        //        config.RateLimitPer10M != Requesters.TournamentApiRequester.RateLimitPer10M)
        //    {
        //        _instance = new TournamentRiotApi(config);
        //    }
        //    return _instance;
        //}
        ...
        public TournamentProvider CreateProvider(Region region, string url)
        {
            ...
            var json = _requester.CreatePostRequest(TournamentRootUrl + CreateProviderUrl, Region.global,
        ...
        public async Task<TournamentProvider> CreateProviderAsync(Region region, string url)
        {
            ...
            var json =
                await
                    _requester.CreatePostRequestAsync(TournamentRootUrl + CreateProviderUrl, Region.global,
                        JsonConvert.SerializeObject(body));
        ...
        public Tournament CreateTournament(int providerId, string name)
        {
            ...
            var json = _requester.CreatePostRequest(TournamentRootUrl + CreateTournamentUrl, Region.global,
                JsonConvert.SerializeObject(body));
        ...
        public async Task<Tournament> CreateTournamentAsync(int providerId, string name)
        {
            ...
            var json =
                await
                    _requester.CreatePostRequestAsync(TournamentRootUrl + CreateTournamentUrl, Region.global,
                        JsonConvert.SerializeObject(body));
            ...
            string metadata)
        {
            ...
            var json = _requester.CreatePostRequest(TournamentRootUrl + CreateCodeUrl, Region.global,
                JsonConvert.SerializeObject(body),
            ...
            TournamentMapType mapType, string metadata)
        {
            ...
            var json =
                await
                    _requester.CreatePostRequestAsync(TournamentRootUrl + CreateCodeUrl, Region.global,
                        JsonConvert.SerializeObject(body),
                        new List<string>
                        {
        ...
        {
            var json = _requester.CreateGetRequest(TournamentRootUrl + string.Format(GetCodeUrl, tournamentCode),
                Region.global);
        ...
        public async Task<TournamentCodeDetail> GetTournamentCodeDetailsAsync(string tournamentCode)
        {
            var json =
                await
                    _requester.CreateGetRequestAsync(TournamentRootUrl + string.Format(GetCodeUrl, tournamentCode),
                        Region.global);
        ...
        {
            var json = _requester.CreateGetRequest(TournamentRootUrl + string.Format(LobbyEventUrl, tournamentCode),
                Region.global);
        ...
        public async Task<List<TournamentLobbyEvent>> GetTournamentLobbyEventsAsync(string tournamentCode)
        {
            var json =
                await
                    _requester.CreateGetRequestAsync(TournamentRootUrl + string.Format(LobbyEventUrl, tournamentCode),
                        Region.global);
            ...
            TournamentSpectatorType? spectatorType, TournamentPickType? pickType, TournamentMapType? mapType)
        {
            ...
            return _requester.CreatePutRequest(TournamentRootUrl + string.Format(PutCodeUrl, tournamentCode), Region.global,
                JsonConvert.SerializeObject(body));
        }
            ...
            TournamentSpectatorType? spectatorType, TournamentPickType? pickType, TournamentMapType? mapType)
        {
            ...
            return await _requester.CreatePutRequestAsync(TournamentRootUrl + string.Format(PutCodeUrl, tournamentCode),
