...
using Sihirdar.WebService.Provider.RiotApi.Model.StatsEndpoint.Enums.Converters;

namespace Sihirdar.WebService.Provider.RiotApi.Model.StatsEndpoint.Enums
{
    /// <summary>
