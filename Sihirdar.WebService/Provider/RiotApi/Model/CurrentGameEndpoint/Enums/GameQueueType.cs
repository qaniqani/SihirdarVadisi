...
using Sihirdar.WebService.Provider.RiotApi.Model.CurrentGameEndpoint.Enums.Converters;

namespace Sihirdar.WebService.Provider.RiotApi.Model.CurrentGameEndpoint.Enums
{
    /// <summary>
