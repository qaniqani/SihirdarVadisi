...
//BACKGROUND CHANGER
  ...
  $(function() {
      ...
      $('.nav-toggle').click(function () {
          ...
          $(collapseContentSelector).slideToggle(function () {
              if ($(this).css('display') == 'block') {
                  ...
                  toggleSwitch.html('<span class="entypo-minus-squared"></span>');
              } else {
                  //change the button label to be 'Hide'
                  toggleSwitch.html('<span class="entypo-plus-squared"></span>');
              }
          });
      });
      ...
      //CLOSE ELEMENT
      $(".gone").click(function () {
          var collapseContentClose = $(this).attr('href');
          $(collapseContentClose).hide();
      });
