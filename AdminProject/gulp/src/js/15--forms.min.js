$(document).ready(function () {
	...
	function userLoggedIn(data) {
		// set div status
		$('.vadi--header--top--sign-in').hide();
		$('.vadi--header--top--user-menu').show();
        ...
        else image = "https://www.gamerpeople.com/html/assets/img/no-image-user.png";
		...
		// fill header fields
		//$('.vadi--header--top--user-menu #loggedInUser').prepend(name + ' ' + surname);
	...
	function userNotLogin() {
		$('.vadi--header--top--sign-in').show();
		$('.vadi--header--top--user-menu').hide();
		userStatus = false;
	}
