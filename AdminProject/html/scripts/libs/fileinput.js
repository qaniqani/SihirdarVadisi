...
(function (factory) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgSizeTooSmall: 'Avatar: "{name}" (<b>{size} KB</b>) Minimum yükleme boyutundan küçük. <b>{minSize} KB</b>.',
        msgSizeTooLarge: 'Avatar: "{name}" (<b>{size} KB</b>) Maksimum yükleme boyutunu aşıyor. <b>{maxSize} KB</b>.',
        msgFilesTooLess: 'You must select at least <b>{n}</b> {files} to upload.',
        msgFilesTooMany: 'Number of files selected for upload <b>({n})</b> exceeds maximum allowed limit of <b>{m}</b>.',
        msgFileNotFound: 'Avatar: "{name}" Bulunamadı!',
        msgFileSecured: 'Güvenlik nedeniyle dosya okunamıyor. "{name}".',
        msgFileNotReadable: 'Avatar: "{name}" formatı düzgün değil.',
        msgFilePreviewAborted: 'Dosya ön gösteriminde hata oluştu. "{name}".',
        msgFilePreviewError: 'Dosya görüntülenirken bir hata oluştu. "{name}".',
        msgInvalidFileName: 'Dosya adında geçersiz karakterler bulundu. "{name}".',
        msgInvalidFileType: 'Geçersiz dosya tipi. Lütfen "{types}" formatlarında yükleyin.',
        msgInvalidFileExtension: 'Geçersiz dosya tipi.',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
