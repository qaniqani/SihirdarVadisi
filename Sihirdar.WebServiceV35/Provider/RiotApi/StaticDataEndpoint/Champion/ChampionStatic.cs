...
using Sihirdar.WebServiceV3.Provider.RiotApi.StaticDataEndpoint.Champion.Enums;
using Sihirdar.WebServiceV3.Provider.RiotApi.StaticDataEndpoint.Champion.Enums.Converters;
